...
- (void)setData:(GroupModel *)groupInfo
{
    ...
    switch (self.groupInfo.selectStatus)
    {
        case SelectStatusAll: {
            _selectStatusView.image = [UIImage imageNamed:@"OutlineView.bundle/select_ture"];
            break;
        }
        case SelectStatusNone: {
            _selectStatusView.image = [UIImage imageNamed:@"OutlineView.bundle/select_false"];
            break;
        }
        case SelectStatusOther: {
            _selectStatusView.image = [UIImage imageNamed:@"OutlineView.bundle/select_few"];
            break;
        }
    }
}
...
- (UIImageView *)iconView
{
    if(!_iconView)
    {
        _iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"OutlineView.bundle/general_nextlevel.png"]];
    }
    return _iconView;
}
...
- (UIImageView *)selectStatusView
{
    ...
    {
        _selectStatusView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"OutlineView.bundle/select_false"]];
    }
